...
<p><a href="/hours/create" class="btn btn-primary" class="btn btn-primary">Aanmaak Schatting</a></p>
@endsection
<!--content-->
@section('content')
<h2>Uren</h2>
<table id="myTable" class="tablesorter table table-striped">
    ...
    @foreach($estimates as $estimate)
        ...
        <a href="/roadmaps/{{ $estimate->roadmap_id }}">Roadmap</a>
        @endif
        </td> 
        <td class="data-tabel">
        <a href="/hours/{{ $estimate->estimate_id }}">{{ $estimate->hour_estimate }}</a>
        </td> 
        <td class="data-tabel">
